<header class="header_content">
	...
	<?php
		...
		else // pas de session
		{
			...
			<div class="logo_gbaf">
				<a href="pages/accueil.php"><img src="pages/logos/gbaf.png" title="GBAF" alt="GBAF logo"/></a>
			</div>
			<div class="inscription_link">
				<a href="pages/inscription.php">S'inscrire</a><p>/</p><a href="index.php">Se connecter</a>
			</div>
			<?php
		}
	?>
